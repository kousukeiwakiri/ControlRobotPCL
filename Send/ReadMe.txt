================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Send プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Send には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Send アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Send.h
   ...
   CSendApp アプリケーション クラスを宣言します。

Send.cpp
   これは、アプリケーション クラス CSendApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Send.ico
   ...
   アイコンはメイン リソース ファイル Send.rc に含まれていま
   す。
...
SendDlg.h, SendDlg.cpp - ダイアログ
   これらのファイルは CSendDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Send.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Send.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
